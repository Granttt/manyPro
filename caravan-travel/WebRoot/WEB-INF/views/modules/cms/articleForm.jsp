		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
                    ...
                    }else if ($("#categoryid").val()=="12b33a3f104046ea819314e779f3315f" || $("#parentid").val()=="24"){
	                    if($("#thumb").val()==""){
	                        top.$.jBox.tip('请添加缩略图','warning');
	                    }
...
<body>
	<ul class="nav nav-tabs">
		...
		<input type="hidden" id="parentid" value="${article.category.parent.id}"/>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
       ...
       <%--  <div id="linkBody" class="control-group" style="display:none">
		...
		<div class="control-group">
			...
			<div class="controls">
                <input type="hidden" id="thumb" name="image" value="${article.imageSrc}" />
				<sys:ckfinder input="thumb" type="images" uploadPath="/cms/article" selectMultiple="true"/>
			</div>
		</div>
			<div class="control-group">
		...
		<%-- <c:if test="${article.category.id eq '12b33a3f104046ea819314e779f3315f' || article.category.parent.id eq 'd5375a31aa1941f885f9b636cf02d515'}">
			<div class="control-group">
