...
function ShowMap(objname,options){
	if(options){
		...
		this._zoom = options.zoom ? options.zoom : "12"; //放大级别，默认14
	}
	//设定初始坐标
	var point=new BMap.Point(113.63156,34.83894);
	//范围为3-18级
	var zoom=this._zoom;
...
//		alert("IP")
	...
	if (this._ismove=="0"){
		...
		//显示窗口设置
		var opts = {width:250,height:50,title : "<font color=green size=3>" + this._title + "</font>"} //窗口标题
