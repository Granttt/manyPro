...
public class Page<T> {
	...
	private boolean front = false; // 设置前后台（false后台）
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled\"><a href=\"javascript:\" class=\"shang\">&#171; 上一页</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\"  class=\"shang\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; 上一页</a></li>\n");
		}
	}else{
	...
	if(front==false){
		if (begin > first) {
			...
			for (i = first; i < first + slider && i < begin; i++) {
				sb.append("<li><a href=\"javascript:\" class=\"normal\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"
						+ (i + 1 - first) + "</a></li>\n");
			}
			if (i < begin) {
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<li class=\"active\"><a class=\"normal current\" href=\"javascript:\">" + (i + 1 - first)
						+ "</a></li>\n");
			} else {
				sb.append("<li><a href=\"javascript:\" class=\"normal\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"
						+ (i + 1 - first) + "</a></li>\n");
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a class=\"xia\" href=\"javascript:\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\"  class=\"xia\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">"
					+ "下一页 &#187;</a></li>\n");
		}
		sb.append("<li class=\"disabled controls\"><a class=\"xia\" href=\"javascript:\">");
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<li><a class=\"normal\" style=\"background:#5bb730;\"  href=\"javascript:\">" + (i + 1 - first)
						+ "</a></li>\n");
			} else {
				sb.append("<li><a href=\"javascript:\" class=\"normal\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"
						+ (i + 1 - first) + "</a></li>\n");
		...
		sb.append("<li>转到</li>");
		sb.append("<li><input type=\"text\" id=\"inptt\" class=\"in_page\" /></li>\n");
		sb.append("<li><a href=\"javascript:\"  class=\"normal2\" onclick=\""+funcName+"("+pageNo+","+pageSize+",'11');\">GO</a></li>\n");
		sb.insert(0,"<ul>\n").append("</ul>\n");
		sb.append("<div style=\"clear:both;\"></div>");
	}	
		return sb.toString();
