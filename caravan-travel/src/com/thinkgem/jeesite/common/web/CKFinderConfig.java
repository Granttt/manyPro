...
public class CKFinderConfig extends Configuration {
	...
	Logger log = Logger.getLogger(CKFinderConfig.class);
...
//			this.baseURL = ServletContextFactory.getServletContext().getContextPath()+"/userfiles/"+principal+"/";
		...
		//	this.baseDir = FileUtils.path(Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/");
			this.baseURL = Global.getVisiteUrl()  + principal + "/";
			//this.baseDir = FileUtils.path(Global.getPhysicalUploadPath()  + Global.USERFILES_BASE_URL + principal + "/");
			this.baseDir = Global.getPhysicalUploadPath()  + Global.USERFILES_BASE_URL + principal + "/";
		} catch (Exception e) {
