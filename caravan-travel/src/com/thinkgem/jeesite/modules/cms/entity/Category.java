...
//	private String parentIds;// 所有父级编号
	private String module; 	// 栏目模型（article：文章；picture：图片；download：下载；link：链接；special：专题;slide : 幻灯模型）
...
//	}
	...
	public String getHrefDynamicSlide() {
		return CmsUtils.getSlideUrlDynamic(this);
	}
