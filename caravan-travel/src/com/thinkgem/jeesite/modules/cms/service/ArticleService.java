...
public class ArticleService extends CrudService<ArticleDao, Article> {
	...
	/**
	 * find web search result
	 * @param page
	 * @param entity
	 * @return
	 */
	@Transactional(readOnly = false)
	public Page<Article> findFrontPage(Page<Article> page, Article entity) {
		entity.setPage(page);
		page.setList(articleDao.findListByCondition(entity));
		return page;
	}
...
//		return dao.find(page, dc);
	...
	@Transactional(readOnly = false)
	public Page<Article> findFuzzyPage(Page<Article> page, Article article) {
		return super.findPage(page, article);
...
//		System.out.println(queryFilter);
	...
	public List<Article> findArticleByCategoryId(String categoryId) {
		...
		return articleDao.findArticleByCategoryId(categoryId);
	}
	public List<Article> findArtByCatParentId(Article article) {
		// TODO Auto-generated method stub
		return articleDao.findArtByCatParentId(article);
	}
